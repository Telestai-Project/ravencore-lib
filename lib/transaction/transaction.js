...
var GENESIS_TX_HASH = '457e7d4f5c3d388fbf90f9a5260ed627a43a0c13f4578d48bc2f983b6ce6e5f7';
var REPLACEMENT_TX_HASH = '9306feb84b68010147727bea70c35f08f679d1c08326a28a5d1534d3c39daf56';
...
var hashProperty = {
  ...
  enumerable: true,
  get: function() {
    let hash = new BufferReader(this._getHash()).readReverse().toString('hex');

    if (hash == REPLACEMENT_TX_HASH) {
